...
PUBLIC_SCRIPT_PATHS = (
    ...
    "./public/modules/edgeTrigger/edge-trigger-live-evaluator.js",
...
WORKLET_BLOB_SOURCE_FILES = (
    ...
    "modules/edgeTrigger/edge-trigger-worklet-evaluator.js",
...
def require_native_module_contract(base_url: str) -> None:
    ...
    expected_native_exports = {
        ...
        "edge_trigger": ["soemdsp_edge_trigger_create", "soemdsp_edge_trigger_destroy", "soemdsp_edge_trigger_sample"],
