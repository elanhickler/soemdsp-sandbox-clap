...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        "Mouse: click to select. Ctrl/Shift+click adds or removes from selection. Drag to move selected module(s).",
    ...
    for snippet in [
        ...
        "--node-port-diameter: calc(var(--node-grid-size) * 0.5714286)",
