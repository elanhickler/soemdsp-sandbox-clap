...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        '"Mouse: click to select. Ctrl/Shift+click adds or removes from selection. Alt+drag moves modules; Ctrl/Shift+Alt+drag adds to selection while moving."',
        ...
        '"Plain drag wires this output area to a signal input or modulation input. Alt+drag moves this patch point if movement is available."',
    ...
    for snippet in [
        ...
        "pickup?.anchorEndpoint || endpoint",
        ...
        'event.target.closest?.(".node-port, .node-param-port.modulation-input")',
