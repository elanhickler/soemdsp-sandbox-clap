...
def require_readme_scheduler_contract() -> None:
    ...
    # supersaw research mission (pitch dithering + Soundemote's own
    # Supersaw/Hypersaw architecture) rather than preserve upstream's
    # aliasing-wars oscillator writeups or the original CLAP-host API
