...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        "const frozenKey = [",
        "frozenBuffer?.nodeGraphScopeFrozenKey === frozenKey",
        ...
        "nodeGraphModuleScopeInterpolatedSample(buffer, samplePosition)",
    ...
    require(
        "buffer[index] = inputBuffer[index] * amount" in node_graph_source,
        "gain module scope should draw the post-gain output signal",
    )
