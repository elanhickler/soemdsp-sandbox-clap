...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        "Copy Host Command",
        "node-graph-clap-host.js?v=clap-under-construction-1",
    ...
    for snippet in [
        ...
        'return Boolean(node && node.type !== "output" && !["home", "goods", "services"].includes(node.id))',
        ...
        "layout === \"visualScope\" ? \" visual-scope-layout\" : \"\"",
        "layout === \"filterCurve\" ? \" filter-curve-layout\" : \"\"",
    ...
    for snippet in [
        ...
        ".node-header-bpm-tap-target:focus-visible",
