...
& $clang `
  ...
  "-Wl,--export=soemdsp_pluck_envelope_metadata_json" `
  "-Wl,--export=soemdsp_pluck_envelope_metadata_json_size" `
  "-Wl,--export-memory" `
...
& $clang `
  ...
  -fno-rtti `
  "-Wl,--no-entry" `
  "-Wl,--export=soemdsp_fractal_spiral_create" `
  "-Wl,--export=soemdsp_fractal_spiral_destroy" `
  "-Wl,--export=soemdsp_fractal_spiral_sample" `
  "-Wl,--export=soemdsp_fractal_spiral_x" `
  "-Wl,--export=soemdsp_fractal_spiral_y" `
  "-Wl,--export=soemdsp_fractal_spiral_z" `
  "-Wl,--export=soemdsp_fractal_spiral_version" `
  "-Wl,--export=soemdsp_fractal_spiral_metadata_json" `
  "-Wl,--export=soemdsp_fractal_spiral_metadata_json_size" `
  "-Wl,--export-memory" `
